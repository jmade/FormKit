...
struct Constants {
    ...
    struct Font {
        static let defaultFont: UIFont = .preferredFont(forTextStyle: .body) // UIFont.systemFont(ofSize: 15)
    }
    
    struct Default {
        static let animationDuration: TimeInterval = 0.3
        static let contentInsets: UIEdgeInsets = UIEdgeInsets(top: 4, left: 8, bottom: 4, right: 8)
        static let font: UIFont = .preferredFont(forTextStyle: .body) //UIFont.systemFont(ofSize: 15)
        static let itemSpacing: CGFloat = 10
        static let textFieldCellMinWidth: CGFloat = 60
        static let labelTextColor: UIColor = UIColor.FormKit.text
        static let textFieldTextColor: UIColor = UIColor.FormKit.text
