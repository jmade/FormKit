...
//                print("Found a Visible Action Cell!")
//                print("\(actionCell)")
//                if enabled {
...
//
//
//    public func changeLastSectionTest(_ newSection:FormSection, enabled:Bool) {
//        print("changeLastSectionTest | \(enabled) | \(newSection.rows.count) |")
//
//        dataSource.sections[dataSource.sections.count-1] = newSection
//
//
//
//
...
//
//
//        if newSection.rows.count == 1 {
//            let cell = tableView.cellForRow(at: IndexPath(row: 0, section: dataSource.sections.count-1))
//            if let actionCell = cell as? ActionCell {
//                print("Got ActionCell")
//                if enabled {
//                    actionCell.setEnabled()
//                } else {
//                    actionCell.setDisabled()
...
//
//
//    public func changeLastSection(_ newSection:FormSection) {
//        changeSection(newSection, at: IndexPath(row: 0, section: dataSource.sections.count-1))
//    }
//
//    public func changeFirstSection(_ newSection:FormSection) {
//        changeSection(newSection, at: IndexPath(row: 0, section: 0))
//    }
//
//
//
//
//
//    public func changeSection(_ newSection:FormSection,at path:IndexPath) {
//        _changeSection(newSection,at: path)
//    }
//
//
//    private func _changeSection(_ newSection:FormSection,at path:IndexPath,_ animation:UITableView.RowAnimation = .fade) {
//
//
